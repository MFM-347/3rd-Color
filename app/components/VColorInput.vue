  ...
  <div class="group relative">
    ...
    <div class="flex flex-row gap-0 rounded-lg shadow-sm sm:rounded-xl">
      <input
        ...
        :value="modelValue"
        @input="onTChange"
        class="min-w-20 flex-1 rounded-l-lg border border-transparent bg-gray-200 px-4 py-1 text-sm ta-175 outline-none placeholder:text-gray-400 focus:ring focus:ring-primary sm:rounded-l-xl sm:py-0.5 sm:text-base dark:border-gray-700 dark:bg-gray-800 dark:placeholder:text-gray-400"
